...
import fondo from './image/wallDashboard.jpeg'
        ...
        <Grid item xs={6} sx={{
          ...
          <Container>
            ...
            <Grid item xs={12} marginBottom={2}>
              <Typography variant="h5" sx={{color:"#666666", textAlign: "center"}} >Universidad de San Carlos</Typography>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography variant="h5" sx={{color:"#666666", textAlign: "center"}} >Facultad de Ingenieria</Typography>
            </Grid>
            <Grid item xs={12}>
              <Typography  sx={{color:"#666666", textAlign: "center", marginBottom:2}}> Ingrese sus datos para obtener acceso al inventario</Typography>
            </Grid>
          {/* *************** */}
          </Container>
          {Formulario}
